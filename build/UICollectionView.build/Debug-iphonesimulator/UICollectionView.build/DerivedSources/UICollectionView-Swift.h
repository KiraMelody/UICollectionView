...
SWIFT_CLASS("_TtC16UICollectionView11AppDelegate")
...
SWIFT_CLASS("_TtC16UICollectionView18CollectionViewCell")
@interface CollectionViewCell : UICollectionViewCell
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, strong) UILabel * __null_unspecified textLabel;
...
@property (nonatomic, copy) NSArray<NSString *> * __nonnull content;
